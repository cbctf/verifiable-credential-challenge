...
- Hyperledger Indy Endorser related updates:
  - Fix order of operations connecting itpss to endorser [\#1716](https://github.com/hyperledger/aries-cloudagent-python/pull/1716) ([ianco](https://github.com/ianco))
...
- Documentation and Demo Updates
  - Use default wallet type askar for holder/itpss demo and bdd tests [\#1761](https://github.com/hyperledger/aries-cloudagent-python/pull/1761) ([ianco](https://github.com/ianco))
  ...
  - Fixes logic for web hook formatter in itpss demo [\#1739](https://github.com/hyperledger/aries-cloudagent-python/pull/1739) ([amanji](https://github.com/amanji))
...
- **AIP 2.0 Features**
  ...
  - Add Revocation notification support to holder/itpss [#1527](https://github.com/hyperledger/aries-cloudagent-python/pull/1527)
- **Other New Features**
...
- **Documentation Additions and Updates**
  ...
  - The holder/itpss demo was updated to allow connections based on Public DIDs to be established, including reusing a connection if there is an existing connection. [#1574](https://github.com/hyperledger/aries-cloudagent-python/pull/1574)
- **Other Fixes**
...
- Updates/Fixes to the holder/itpss demo and integration tests
  ...
  - Fix issue with startup sequence for itpss agent [#1415](https://github.com/hyperledger/aries-cloudagent-python/pull/1415)
...
- Handle connection invitations in base64 or URL format in the holder demo agent [#186](https://github.com/hyperledger/aries-cloudagent-python/pull/186)
...
- Updated API demo docs to use holder/itpss scripts [#54](https://github.com/hyperledger/aries-cloudagent-python/pull/54)
...
- holder-itpss demo update [#28](https://github.com/hyperledger/aries-cloudagent-python/pull/28)
