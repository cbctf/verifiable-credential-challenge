...
def test_1pu_hex_example():
    ...
    holderEphemeralSecretKey = (
        "b5b1158f6fba847407853cdf4bfbcf120412e25918eb15d5a1e7fe04570f6907"
    )
    holderEphemeralPublicKey = "04bf4e51d403a9cdfcfa2fe38abf6229db33f59ac14395e92f5b353af213391484f017d3d336f4e03ca974285722641be48d98d5589104ab99abe702fb2bfa6fe2"
    ...
    holderKey = derive_sender_1pu(
        holderEphemeralSecretKey, holderSecretKey, bobPublicKey, alg, apu, apv, keydatalen
    )
    print("holder 1PU key: ", holderKey.hex())
    bobKey = derive_receiver_1pu(
        holderEphemeralPublicKey, holderPublicKey, bobSecretKey, alg, apu, apv, keydatalen
    )
...
def test_1pu_appendix_example():
    ...
    holderSecretKey = b64_to_bytes(d, urlsafe=True).hex()
    holderPublicKey = (
    ...
    # holder Ephemeral Key
    d = "0_NxaRPUMQoAJt50Gz8YiTr8gRTwyEaCumd-MToTmIo"
    x = "gI0GAILBdu7T53akrFmMyGcsF3n5dO7MmwNBHKW5SV0"
    y = "SLW_xSffzlPWrHEVI30DHM_4egVwt3NQqeUD7nMFpps"

    holderEphemeralSecretKey = b64_to_bytes(d, urlsafe=True).hex()
