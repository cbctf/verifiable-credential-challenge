...
Once the itpss agent has started up (with the invite displayed), click the link near the top of the screen `8021`. That will start an instance of the OpenAPI/Swagger user interface connected to the itpss instance. Note that the URL on the OpenAPI/Swagger instance is: `http://ip....8021.direct...`.
...
<details>
    ...
    <img src="./collateral/itpss-Agent.png" alt="Swagger Page for itpss Agent">
</details>
...
<details>
    <summary>Show me a screenshot!</summary>
    <img src="./collateral/holder-Agent.png" alt="Swagger Page for holder Agent">
</details>
...
To begin running the demo in Docker, open up two terminal windows, one each for itpss’s and holder’s agent.
...
<details>
    <summary>Show me a screenshot!</summary>
    <img src="./collateral/itpss-Agent-Local.png" alt="Swagger Page for itpss Agent">
</details>
...
<details>
    <summary>Show me a screenshot!</summary>
    <img src="./collateral/holder-Agent-Local.png" alt="Swagger Page for holder Agent">
</details>
...
In the itpss browser tab, navigate to the **`POST /connections/create-invitation`** endpoint. Replace the sample body with and empty production (`{}`) and execute the call. If successful, you should see a connection id, an invitation, and the invitation URL. The connection ids will be different on each run.
...
<details>
    ...
    <img src="./collateral/1-itpss-Invitation-1.png" alt="Create Invitation Request">
</details>

<details>
    <summary>Show me a screenshot - Create Invitation Response</summary>
    <img src="./collateral/1-itpss-Invitation-2.png" alt="Create Invitation Response">
</details>
...
<details>
    <summary>Show me a screenshot - Create Invitation Response</summary>
    <img src="./collateral/1-itpss-Invitation-3.png" alt="Create Invitation Response">
</details>
...
<details>
    <summary>Show me a screenshot - itpss Connection Status</summary>
    <img src="./collateral/1-itpss-Invitation-4.png" alt="itpss Connection Status">
</details>
...
<details>
    ...
    <img src="./collateral/2-holder-Invitation-1.png" alt="Receive Invitation Request">
</details>

<details>
    <summary>Show me a screenshot - Receive Invitation Response</summary>
    <img src="./collateral/2-holder-Invitation-2.png" alt="Receive Invitation Request">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/2-holder-Invitation-3.png" alt="Invitation Status">
</details>
...
<details>
    ...
    <img src="./collateral/2-holder-Invitation-4.png" alt="Receive Invitation Request">
</details>

<details>
    <summary>Show me a screenshot - Accept Invitation Response</summary>
    <img src="./collateral/2-holder-Invitation-5.png" alt="Receive Invitation Response">
</details>
...
<details>
    ...
    <img src="./collateral/3-itpss-Connection-2.png" alt="Connection Request Event">
</details>
...
<details>
    ...
    <img src="./collateral/3-itpss-Connection-3.png" alt="Accept Connection Request">
</details>

<details>
    <summary>Show me a screenshot - Accept Connection Request</summary>
    <img src="./collateral/3-itpss-Connection-4.png" alt="Accept Connection Request">
</details>
...
<details>
    <summary>Show me a screenshot - holder Connection Status</summary>
    <img src="./collateral/4-holder-Connection-2.png" alt="holder Connection Event">
</details>
...
<details>
    <summary>Show me the event</summary>
    <img src="./collateral/4-holder-Connection-1.png" alt="holder Connection Status">
</details>
...
<details>
    <summary>Show me a screenshot - itpss Connection Status</summary>
    <img src="./collateral/5-itpss-Connection-1.png" alt="itpss Connection Status">
</details>
...
### Sending a message from holder to itpss
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/6-holder-Basic-Msg.png" alt="holder Send Message">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/7-itpss-Basic-Msg.png" alt="itpss Receive Message">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/8-holder-Basic-Msg.png" alt="holder Receive Message Confirmation">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/C-1-itpss-DID-Public.png" alt="itpss Public DID">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/C-2-itpss-Ledger-Search-0.png" alt="Search Ledger by DID">
</details>
...
<details>
    ...
    <img src="./collateral/C-2-itpss-Ledger-Search-1.png" alt="DID Transaction">
    <img src="./collateral/C-2-itpss-Ledger-Search-2.png" alt="DID Endpoint Transaction">
    <img src="./collateral/C-2-itpss-Ledger-Search-3.png" alt="Schema Transaction">
    <img src="./collateral/C-2-itpss-Ledger-Search-4.png" alt="Credential Definition Transaction">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/C-3-itpss-Info-2.png" alt="Search Schemas">
    <img src="./collateral/C-3-itpss-Info-3.png" alt="Search Schemas">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/C-3-itpss-Info-4.png" alt="Search Credential Definitions">
    <img src="./collateral/C-3-itpss-Info-5.png" alt="Search Credential Definitions">
</details>
...
<details>
    ...
    <img src="./collateral/C-3-itpss-Info-1.png" alt="Connection Id">
</details>
...
<details>
    ...
    <img src="./collateral/C-4-itpss-Credential-Offer-1.png" alt="itpss Submit Credential Offer">
    <img src="./collateral/C-4-itpss-Credential-Offer-2.png" alt="itpss Submit Credential Offer">
</details>
...
<details>
    ...
    <img src="./collateral/C-5-holder-Credential-Offer-1.png" alt="Issue Credential">
</details>
...
<details>
    ...
    <img src="./collateral/C-7-holder-Store-Credential-1.png" alt="">
    <img src="./collateral/C-7-holder-Store-Credential-2.png" alt="">
</details>
...
<details>
    ...
    <img src="./collateral/C-7-holder-Store-Credential-3.png" alt="">
    <img src="./collateral/C-7-holder-Store-Credential-4.png" alt="">
</details>
...
<details>
    <summary>Show me itpss's event activity</summary>
    <img src="./collateral/C-6-itpss-Credential-Request.png" alt="">
    <img src="./collateral/C-8-itpss-Credential-Ack-0.png" alt="">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="./collateral/C-8-itpss-Credential-Ack-1.png" alt="">
    <img src="./collateral/C-8-itpss-Credential-Ack-2.png" alt="">
</details>
...
<details>
    ...
    <img src="./collateral/P-1-itpss-Proof-Request-1.png" alt="Send Proof Request">
    <img src="./collateral/P-1-itpss-Proof-Request-2.png" alt="Send Proof Request">
</details>
...
<details>
    <summary>Show me holder's event activity</summary>
    <img src="./collateral/P-2-holder-Proof-Request-1.png" alt="Proof Request">
    <img src="./collateral/P-2-holder-Proof-Request-2.png" alt="Proof Request">
</details>
...
<details>
    <summary>Show me itpss's event activity</summary>
    <img src="./collateral/P-3-itpss-Proof-1.png" alt="Receive and Verify Proof">
    <img src="./collateral/P-3-itpss-Proof-2.png" alt="Receive and Verify Proof">
    <img src="./collateral/P-3-itpss-Proof-3.png" alt="Receive and Verify Proof">
</details>
...
| Protocol Step        | itpss (Verifier)       | holder (Holder/Prover)     | Notes |
| -------------------- | ---------------------- | ------------------------- | ----- |
