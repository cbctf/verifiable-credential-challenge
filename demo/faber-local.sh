#!/bin/bash
# this runs the itpss example as a local instace of instance of aca-py
...
PYTHONPATH=.. ../bin/aca-py start \
   ...
   --admin-insecure-mode \
   --wallet-type askar \
   --wallet-name itpss.agent916333 \
   --wallet-key itpss.agent916333 \
   --preserve-exchange-records \
   --auto-provision \
   --genesis-url http://localhost:9000/genesis \
   --trace-target log \
   --trace-tag acapy.events \
   --trace-label itpss.agent.trace \
