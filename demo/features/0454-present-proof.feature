Feature: RFC 0454 Aries agent present proof
   ...
   Scenario Outline: Present Proof where the prover does not propose a presentation of the proof and is acknowledged
      ...
      And "itpss" and "Bob" have an existing connection
      When "itpss" sends a request for proof presentation <Proof_request> to "Bob"
      Then "itpss" has the proof verified

      Examples:
         | issuer | Acme_capabilities                      | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | itpss  | --public-did                           |                           | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
         | itpss  | --public-did --did-exchange            | --did-exchange            | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
   ...
   Scenario Outline: Present Proof json-ld where the prover does not propose a presentation of the proof and is acknowledged
      ...
      And "itpss" and "Bob" have an existing connection
      When "itpss" sends a request for json-ld proof presentation <Proof_request> to "Bob"
      Then "itpss" has the proof verified

      Examples:
         | issuer | Acme_capabilities                                         | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | Acme   | --public-did --cred-type json-ld                          |                           | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
         | itpss  | --public-did --cred-type json-ld --did-exchange           | --did-exchange            | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
   ...
   Scenario Outline: Present Proof where the issuer revokes the credential and the proof fails
      ...
      And "itpss" and "Bob" have an existing connection
      When "itpss" sends a request for proof presentation <Proof_request> to "Bob"
      Then "itpss" has the proof verification fail

      Examples:
         | issuer | Acme_capabilities                          | Bob_capabilities | Schema_name       | Credential_data   | Proof_request     |
         | itpss  | --revocation --public-did                  |                  | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
         | itpss  | --revocation --public-did --did-exchange   | --did-exchange   | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
   ...
   Scenario Outline: Present Proof for multiple credentials where the one is revocable and one isn't
      Given we have "4" agents
         ...
         | itpss | verifier | <Acme1_capabilities> |
         | Bob   | prover   | <Bob_cap>   |
